...
ui <- fluidPage(
  titlePanel("Macro economic variables"),
  sidebarLayout(
   sidebarPanel(
      # Add any input options here if needed
       ...
       selectInput("veks","Form",c("nvalue","lnalue","lvalue","growth")),
       textInput("datef", "Select fra dato:", value = "2018-01-01"),
       textInput("datet", "Select til dato:", value = "2022-01-01")
    ),
   mainPanel(
     tabsetPanel(
